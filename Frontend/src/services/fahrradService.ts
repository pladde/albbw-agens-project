...
export const fahrradService = {
     ...
     * @returns {Promise<Record<string, any> | null>} Das vom Server erstellte Objekt (inkl. generierter ID) oder null bei Fehler.
     */
     ...
     * @returns {Promise<Record<string, any> | null>} Das gefundene Fahrrad oder `null` bei Fehler.
     */
     ...
     * @returns {Promise<Record<string, any> | null>} Gibt das Array mit den gefundenen Fahrrädern oder `null` bei Fehler zurück.
     */
     ...
     * @param {number} id - Der PK des Fahrrads.
     * @returns {Promise<Record<string, any> | null>} Gibt das gelöscht Fahrrad-Objekt oder `null` bei Fehler zurück.
     */
    deleteById: async (id: number): Promise<Record<string, any> | null> => {
     ...
     * @returns {Promise<Record<string, any> | null>} Gibt den überarbeiteten Datensatz oder `null` bei Fehler zurück.
     */
