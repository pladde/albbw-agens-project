...
export default function(fahrradController: FahrradController) {
    ...
    router.get('/th', (req, res) => fahrradController.getTableColumns(req, res));
    ...
    router.get('/att', (req, res) => fahrradController.findAllWithAttributes(req, res));

    router.delete('/:id', (req, res) => fahrradController.deleteFahrradById(req, res));

    router.put('/:id', (req, res) => fahrradController.updateFahrradById(req, res));
